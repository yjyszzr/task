...
//		List<DlResultBasketball> matchResults = dlResultBasketballMapper.queryMatchResultsByChangciIds(changciIds);
		...
		for(JsonResultBasketball basketBallResult:jsonResultBasketballList) {
            ...
            if(org.apache.commons.lang3.StringUtils.isNotEmpty(mnl_result)) {
            ...
            if(org.apache.commons.lang3.StringUtils.isNotEmpty(hdc_result)) {
            ...
            if(org.apache.commons.lang3.StringUtils.isNotEmpty(wnm_result)) {
            ...
            if(org.apache.commons.lang3.StringUtils.isNotEmpty(hilo_result)) {
                        ...
                        for (String stake : stakesarr) {
                            ...
                            if (stake.contains(playCode)) {
                                ...
                                if (isCancel) {
                                    ...
                                    // 比赛结果获取中奖信息
                                    matchResultList.removeIf(s->StringUtils.isEmpty(s.getPlayCode()));
